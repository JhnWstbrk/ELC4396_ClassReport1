...
REM
REM Generated by Vivado on Sun Sep 10 21:32:32 -0500 2023
...
echo "xvlog --incr --relax -L uvm -prj disp_mux_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj disp_mux_test_vlog.prj -log xvlog.log
